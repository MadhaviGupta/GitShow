...
export default function Testimonials() {
  return (
    <>
      ...
      <div className="h-auto mx-48 flex justify-around">
        <div className="w-1/4 h-80 bg-blue-200 hover:bg-blue-100 rounded-2xl my-4 mx-2 p-3 flex shadow-2xl">
        ...
        <div className="w-1/4 h-80 bg-blue-200 hover:bg-blue-100 rounded-2xl my-4 mx-2 p-3 flex shadow-2xl">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">Developer, C language</p>
            <p className="text-orange-700">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Reiciendis dolore, eveniet doloribus sapiente quaerat libero
              fugiat, enim voluptas nisi eos quidem soluta
