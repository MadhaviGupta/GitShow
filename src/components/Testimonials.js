    ...
    <>
      ...
      <div className="h-auto mx-10 md:mx-48">
        <div className="flex flex-col md:flex-row justify-around">
          <div className="md:w-1/4 h-80 text-orange-600 hover:text-purple-700 cursor-default bg-blue-100 bg-opacity-90 hover:bg-black transition-all duration-500 ease-out rounded-xl my-4 mx-2 p-5 flex shadow-xl">
