...
export default function Sidebar() {
  return (
    <div className="w-full z-50 fixed bottom-0 md:top-0 md:left-48 md:w-1/6 md:h-screen bg-black bg-opacity-20 backdrop-blur-lg rounded-2xl md:m-3 md:p-3 flex flex-row md:flex-col md:items-center text-white text-xl">
