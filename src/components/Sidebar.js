...
export default function Sidebar() {
  return (
    <div className="w-full z-50 fixed bottom-0 md:static md:w-1/5 md:h-screen bg-black bg-opacity-20 backdrop-blur-lg rounded-2xl md:m-3 md:p-3 flex flex-row md:flex-col md:items-center text-white text-xl">
      <ul className="w-full flex justify-around items-center md:items-start md:flex-col p-2 md:p-0">
        ...
        <li className="md:block hidden w-full">
          <Link to={"#"}>
            <div className="flex text-orange-500 bg-black rounded-full p-2 justify-center">
