...
export default function Sidebar() {
  return (
    <div className="w-full fixed bottom-0 md:static md:w-1/5 md:h-screen bg-black bg-opacity-20 backdrop-blur-lg rounded-2xl md:my-3 md:p-3 flex flex-row md:flex-col md:items-center text-white text-xl">
      <ul className="w-full flex justify-around items-center md:items-start md:flex-col p-2 md:p-0">
        ...
        <li className="md:mx-5 md:mt-10 md:mb-2">
          <Link to={"/home"}>
            <div className="flex hover:text-orange-700 hover:bg-black hover:rounded-full md:p-2 text-2xl p-2 md:w-full">
              <AiOutlineHome className="md:m-2 m-auto" />
              <span className="m-1 hidden md:block">Home</span>
            </div>
          </Link>
        </li>
        <li className="mx-5 md:mb-2">
          <Link to={"/explore"}>
        ...
        <li className="md:block  hidden mx-5">
          <Link to={"#"}>
